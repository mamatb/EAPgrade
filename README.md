...
```
[+] done! Now the WPA/WPA2-MGT fake AP attack should launch automatically after booting, raw logs will be located at "/opt/eaphammer/logs/hostapd-eaphammer.raw". Next steps:
